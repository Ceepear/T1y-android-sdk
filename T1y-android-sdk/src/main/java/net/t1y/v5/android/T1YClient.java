...
public class T1YClient {
    ...
    public T1YClient(String baseUrl, int appId, String apiKey, String secretKey) {
        ...
        this.gson = new GsonBuilder().disableHtmlEscaping().setExclusionStrategies(new ExclusionStrategy() {
    ...
    public String deleteAll(String table,String ids){
        return sendRequest("DELETE", table + "/batch", ids);
    }

    public String createAll(String table,String beans){
        return sendRequest("POST", table + "/batch", beans);
    }
    ...
    <T> String updateOne(String table, String id, String data) {
        return sendRequest("PUT", table + "/" + id, data);
    }
    ...
    public String sendRequest(String method, String table, String data) {
        ...
        Request.Builder requestBuilder = new Request.Builder()
                ...
                .header("X-T1Y-Safe-Timestamp", String.valueOf(timestamp))
    ...
    public String query(String simpleName, String string) {
        return sendRequest("POST", simpleName + "/query", string);
    }
}
